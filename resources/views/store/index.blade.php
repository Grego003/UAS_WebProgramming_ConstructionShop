    ...
    <div class="container-fluid mt-5">
        <ul class="nav nav-tabs border-bottom mb-3">
            @foreach ($categories as $category)
                <li class="nav-item">
                    <a class="nav-link active mx-3 mb-2" aria-current="page" tabindex="5"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="d-inline" action="/stores/{{ $product->id }}" method="post"
                                id="del{{ $product->id }}">
                                @method('DELETE')
                                @csrf
                                <button style="border: 0pt" class="badge rounded-pill bg-danger"
                                    data-id="del{{ $product->id }}" onclick="confirmDelete(event)"
