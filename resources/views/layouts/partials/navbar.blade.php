            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="hidden fixed top-0 right-0 px-6 py-1 sm:block">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-sm btn btn-light text-dark text-decoration-none">Log in</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="text-sm btn btn-light text-dark text-decoration-none">Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
